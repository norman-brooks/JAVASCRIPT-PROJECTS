...
const Calculator = {
    ...
    Display_Value: '0',
    //This will hold the first operand for any expressinos, we set it to null for now
    First_Operand: null, 
...
//This section handles decimat points.
...
//This function updates the calculator screen with the contents of Dispplay_Value
...
keys.addEventListener('click', (event) => {
    ...
    //that was clicked
    const { target } = event;
    //If the element that was clikced on is not a button, exit the function
